...
########################################
##### Sistema BitScola - Versão 7  #####
########################################

###
### Recupera os dados do arquivo, caso existam dados armazenados
### Se não existirem, cria arquivos vazios para cada módulo
###
...
# turmas = {
#     # Código da Turma: [Nome da Turma, Horário, Local, CPF do Professor]
